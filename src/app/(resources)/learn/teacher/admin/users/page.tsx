...
import { AdminUsersClient } from "@/components/platform/AdminUsersClient";
    ...
    <div className="bg-[#f3edf6] dark:bg-[#0b0f14]">
      <div className="mx-auto max-w-6xl px-4 py-10 space-y-6">
        <header className="space-y-3">
          ...
          <h1 className="text-4xl font-extrabold tracking-tight text-black dark:text-white">Users</h1>
          <p className="max-w-2xl text-sm text-black/70 dark:text-white/70">
            View registered users and manage roles and access. Admin access required.
          </p>
        </header>
