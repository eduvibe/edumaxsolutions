...
function mapMcqRowToQuestion(row: DbRow, subjectId: string, topicId: string): McqQuestion {
  ...
  return {
    ...
    questionTextJson: (pick(row, ["question_text_json", "questionTextJson"]) as unknown as McqQuestion["questionTextJson"]) ?? null,
    ...
    optionATextJson: (pick(row, ["option_a_text_json", "optionATextJson"]) as unknown as McqQuestion["optionATextJson"]) ?? null,
    ...
    optionBTextJson: (pick(row, ["option_b_text_json", "optionBTextJson"]) as unknown as McqQuestion["optionBTextJson"]) ?? null,
    ...
    optionCTextJson: (pick(row, ["option_c_text_json", "optionCTextJson"]) as unknown as McqQuestion["optionCTextJson"]) ?? null,
    ...
    optionDTextJson: (pick(row, ["option_d_text_json", "optionDTextJson"]) as unknown as McqQuestion["optionDTextJson"]) ?? null,
    ...
    explanationJson: (pick(row, ["explanation_json", "explanationJson"]) as unknown as McqQuestion["explanationJson"]) ?? null,
    dateCreated: String(pick(row, ["date_created", "dateCreated"]) ?? nowIso()),
  };
}
